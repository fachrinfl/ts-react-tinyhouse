    ...
    return (
        <Content className="host-content">
            <Form layout="vertical" onSubmit={handleHostListing}>
                ...
                <Item label="Image" extra="Images have to be under 1MB in size and of type JPG of PNG">
...
const beforeImageUpload = (file: File) => {
    const faleIsValidImage = file.type === "image/jpeg" || file.type === "image/png";
    ...
    return faleIsValidImage && fileIsValidSize;
}
...
const getBase64Value = (
    ...
    console.log('getBase64Value:img ', img);
    const reader = new FileReader();
    reader.readAsDataURL(img);
    reader.onload = () => {
        console.log('getBase64Value:reader ', reader);
